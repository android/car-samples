...
public final class FavoritesScreen extends Screen {
    ...
    for (PlaceInfo place : getFavorites()) {
      ...
      listBuilder.addItem(
          Row.builder()
              ...
              .addText(address)
              .setOnClickListener(() -> onClickFavorite(place))
  ...
  private List<PlaceInfo> getFavorites() {
    ...
    PlaceInfo home =
        new PlaceInfo(getCarContext().getString(R.string.home_destination_label), "9 10th Street.");
    favorites.add(home);
    PlaceInfo work =
        new PlaceInfo(getCarContext().getString(R.string.work_destination_label), "2 3rd Street.");
    favorites.add(work);
